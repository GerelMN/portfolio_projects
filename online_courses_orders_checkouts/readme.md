...
* Сравнение конверсий двух групп с помощью Z-теста пропорций показало, что оснований утверждать, что разница стат.значима нет. 
...
* Без учета аномальных данных сравнение среднего чека по двум группам с помощью T-критерия Уэлша не дало стат.значимого результата
